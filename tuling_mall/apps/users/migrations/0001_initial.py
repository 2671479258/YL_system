...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tijian_Data', models.DateField(default='无数据', verbose_name='体检时间')),
                ('height', models.CharField(default='无数据', max_length=15, verbose_name='身高')),
                ('weight', models.CharField(default='无数据', max_length=15, verbose_name='体重')),
                ('lefteye', models.CharField(default='无数据', max_length=8, verbose_name='左眼视力')),
                ('righteye', models.CharField(default='无数据', max_length=8, verbose_name='右眼视力')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='测试人')),
            ],
            options={
                'verbose_name': '体检记录管理',
                'verbose_name_plural': '体检记录管理',
                'db_table': 'tb_tj',
            },
        ),
        migrations.CreateModel(
